...
- [x] **SAAS-01**: Self-service signup creates a new organisation with onboarding flow (tour, sample data, CSV import)
...
- [x] **ADMIN-01**: Super-admin support tooling (impersonation, plan overrides, usage review)
- [x] **MARKETING-01**: Documentation site, marketing site, status page
