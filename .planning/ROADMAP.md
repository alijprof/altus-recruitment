...
- [ ] 06-01-PLAN.md — Harness scaffolding, jszip dependency gate, Postgres-legality classifier (wave 1)
- [ ] 06-02-PLAN.md — Read-only forensic replay of the 12 production failures (wave 2)
- [ ] 06-03-PLAN.md — Fixture corpus: generator, Tier-1/Tier-2/hostile binaries, manifest (wave 2)
