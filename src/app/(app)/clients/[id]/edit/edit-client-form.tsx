...
import { clientFormSchema, type ClientFormInput } from '../../new/schema'
...
export function EditClientForm({ clientId, defaults }: EditClientFormProps) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} value={field.value ?? ''} placeholder="Offshore wind" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
